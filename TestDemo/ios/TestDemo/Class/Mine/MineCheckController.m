...
@interface MineCheckController ()<UITableViewDataSource, UITableViewDelegate>
@property(nonatomic, weak)UITableView *tableView;
@property(nonatomic, strong)NSMutableArray *dataArray;
@property(nonatomic, strong)NSString *month;
@end

@implementation MineCheckController
...
- (void)fetchCheckList {
    ...
    weakify(self);
    [[RJHTTPClient sharedInstance] fetchUserCheckListWithPage:1 completion:^(WebResponse *response) {
