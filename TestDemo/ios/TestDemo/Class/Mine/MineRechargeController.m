...
@interface MineRechargeController ()<UITableViewDelegate, UITableViewDataSource>
@property(nonatomic, weak)UITableView *tableView;
@property(nonatomic, strong)NSMutableArray *dataArray;
@property(nonatomic, strong)NSString *month;
@end

@implementation MineRechargeController
...
- (void)fetchCheckList {
    ...
    weakify(self);
    [[RJHTTPClient sharedInstance] fetchUserRechargeListWithPage:1 completion:^(WebResponse *response) {
